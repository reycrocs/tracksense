...
//=========================== WiFi & Interval
const char* ssid = "Extender 24";
const char* password = "ExtenderNova";
...
void sendPhotoToImgBB() {
  ...
  HTTPClient http;
  const String apiKey = "077ff53525c7e140eecf54d68ebe5884";  // Replace with your actual ImgBB API key
